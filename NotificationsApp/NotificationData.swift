...
struct NotificationData {
    static let womenNames = ["Emma", "Olivia", "Sophia", "Isabella", "Ava"]
    static let menNames = ["Liam", "Noah", "Oliver", "Elijah", "James"]
    ...
    static let friendMessagesWomen = [
        ...
        "Wanna catch up this week?",
        "It’s been too long!",
        "I saw something that reminded me of you.",
        "You always know how to cheer me up!",
        "Hope everything’s okay 💛",
        "What are you watching lately?",
        "Thinking about our last coffee run ☕️",
        "You always give the best advice!",
        "Can I vent to you later?",
        "You’re one of my favorite people.",
        "Let’s plan a chill night soon.",
        "Are you free to talk for a bit?",
        "Miss our random convos.",
        "Let me know when you’re free!",
        "You make life better. Just saying 💖",
    ...
    static let friendMessagesMen = [
        ...
        "Hit me back when free",
        "You around later?",
        "Game night soon?",
        "We overdue for a catch-up bro.",
        "You watching the game?",
        "Let’s hit the gym soon.",
        "I saw something hilarious — gotta show you.",
    ...
    static let flirtyMessages = [
        ...
        "How have you been?",
        "Can we meet up?",
        "Lowkey been thinking about you all day 😅",
        ...
        "I always smile when I see your name pop up.",
        "Let’s stop pretending we’re just friends 😉",
        "You’re trouble. The good kind.",
        "You still owe me a date btw 😌",
        "Tell me something cute. Or just call me.",
        "I’m bored. Fix that?",
        "You + me + tonight = ?",
        "You always know how to make me smile 😘",
        "Why do I keep smiling when I think of you?",
        "If I said I was thinking about you... would that be weird?",
        "You’re kinda my favorite distraction 🤭",
        "Are you always this charming, or is it just with me?",
        "One text from you can change my whole mood 🥰",
        "If I say I miss you, will you do something about it?",
    ...
    static func getNames(for category: String) -> [String] {
        ...
        case "Mostly Women": return mostlyWomenNames
        case "Mostly Men": return mostlyMenNames
